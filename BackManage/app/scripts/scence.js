...
'use strict';
var back, city_init, clearmap, commit, get_scene, get_scenes, hide_cities, hide_scenes, hide_sub, is_province, mark, markbiao, prov_city, save, search, show_sub, substringMatcher,
...
get_scenes = function(name) {
  ...
  map.setZoom(is_province(name) ? 7 : 12);
  map.setCenter(name);
  $.ajax({
    type: "GET",

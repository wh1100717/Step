...
city_init = ->
	prov_city_typeahead = $("#prov_city").typeahead(
		...
		}
		{
			...
			templates: {
				header: '<h3 style="margin: 0 20px 5px 20px;padding: 3px 0;border-bottom: 1px solid #ccc;">省份</h3>'
			}		
		}
		{
			name: 'city'
			...
			templates: {
				header: '<h3 style="margin: 0 20px 5px 20px;padding: 3px 0;border-bottom: 1px solid #ccc;">城市</h3>'
			}
		}
	)
